...
let img = [
  "./assets/img/fomoMockExchange.jpg",
  "./assets/img/noteTaker.jpg",
  "./assets/img/emprise.jpg",
];
let imgPrev = [
  "./assets/img/previews/imgPreview.jpeg",
  "./assets/img/previews/img2Preview.jpeg",
  "./assets/img/previews/img3Preview.jpeg",
];
let site = [
  "https://fomo-exchange.herokuapp.com/",
  "https://salty-dawn-40447.herokuapp.com/",
  "https://codemasterdev.github.io/Project-1/",
];
let repo = [
  "https://github.com/RynMrphy18/fomo-mock-exchange",
  "https://github.com/PandolfoM/note-taker",
  "https://github.com/codemasterdev/Project-1",
];
...
$(document).ready(function () {
  ...
  $("#workBtnRight").click(function () {
    workPage++;
    if (workPage === 1) {
      $(".workSection ").addClass(
        "animate__animated animate__fadeIn animate__faster"
      );
      setTimeout(function () {
        $(".workSection").removeClass(
          "animate__animated animate__fadeIn animate__faster"
        );
      }, 500);
    }
    ...
    if (workPage === 1) {
      // Page 2 details
      let title = ["Half Foods", "Tech Blog", "Weather Dashboard"];
      let desc = [
        "Online grocery store where you can buy items to pickup later",
      ...
      let img = [
        "./assets/img/halfFoods.jpg",
        "./assets/img/techBlog.jpg",
        "./assets/img/weatherDashboard.jpg",
      ];
      let imgPrev = [
        "./assets/img/previews/img4Preview.jpeg",
        "./assets/img/previews/img5Preview.jpeg",
        "./assets/img/previews/img6Preview.jpeg",
      ];
      let site = [
        "https://stark-dawn-47619.herokuapp.com/",
        "https://desolate-forest-49599.herokuapp.com/",
        "https://pandolfom.github.io/weather-dashboard/",
      ];
      let repo = [
        "https://github.com/PandolfoM/half-foods",
        "https://github.com/PandolfoM/tech-blog",
        "https://github.com/PandolfoM/weather-dashboard",
      ];
      workPageContent(...title, ...desc, ...img, ...imgPrev, ...site, ...repo);
    }
  });
  ...
  // Animations
  $(".nameTitle").toggleClass(
    "animate__animated animate__fadeInLeft animate__slow"
  );
  $(".subtitle").toggleClass(
    "animate__animated animate__fadeInLeft animate__delay-1s animate__slow"
  );
  $(".pfp").toggleClass(
